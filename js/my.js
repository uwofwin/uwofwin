        ...
        $.ajax({
            ...
            success: function(result) {
                if (result != null && result != undefined) {
                    bigArea = result.bigArea
                    if (isNull(bigArea)) {
                        bigArea = 0;
                    }
                    smallArea = result.smallArea
                    if (isNull(smallArea)) {
                        smallArea = 0;
                    }
                    vip1Num = result.vip1Num;
                    vip2Num = result.vip2Num;
                    vip3Num = result.vip3Num;
                    vip4Num = result.vip4Num;
                    ...
                    var totalInvest = smallPoolPrize[2] / 1000000;
